...
def evaluate(real, synth, outdir):
    ...
    plot_sequences(real,synth,outdir,1)
    plot_sequences(real,synth,outdir,2)
    plot_sequences(real,synth,outdir,3)
    plot_sequences(real,synth,outdir,4)
...
def main():
    ...
    if args.feature_idx is not None:
        print("Using feature indices:", args.feature_idx)
